import { Margin, PinOutlined } from "@mui/icons-material";
    ...
    return (
     <div style={{
      ...
      <section style={{
        ...
        <h2 style={{fontSize:'50px',fontFamily:'cursive'}}  >SignUp</h2>
          ...
          width:'90%'
                ...
                <div>
                    <label style={{fontSize:'30px',fontFamily:'cursive'}} className="text-gray-700 dark:text-gray-200" htmlFor="emailAddress">Email Address</label>
                    <input style={{backgroundColor:'red'}} id="emailAddress" type="email" className=" shadow-lg p-3 mb-5 bg-body rounded block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-rounded border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                </div>
                ...
                <div>
                    <label style={{fontSize:'30px',fontFamily:'cursive'}} className="text-gray-700 dark:text-gray-200" htmlFor="passwordConfirmation"> Confirmation</label>
                    <input style={{backgroundColor:'red'}} id="passwordConfirmation" type="password" className="shadow-lg p-3 mb-5 bg-body rounded block w-full px-4 py-2 mt-2 text-gray-700 bg-white border-rounded border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                </div>
                <button style={{fontSize:'20px'}} className=" col-3 btn btn-info">Save</button>
            </div>
